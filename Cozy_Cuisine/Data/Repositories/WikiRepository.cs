...
namespace Cozy_Cuisine.Data.Repositories
{
    public class WikiRepository : IWikiRepository
    {
        ...
        // WIKI
        public async Task<IEnumerable<Wiki>> GetAllWikisAsync() => await _context.Wiki.ToListAsync();
        ...
        // STORY PLOT
        public async Task<IEnumerable<StoryPlot>> GetAllStoryPlotsAsync() => await _context.StoryPlot.ToListAsync();
        ...
        public async Task DeleteStoryPlotAsync(int id) { var item = await _context.StoryPlot.FindAsync(id); if (item != null) { _context.StoryPlot.Remove(item); await _context.SaveChangesAsync(); } }

        // CHARACTERS
        public async Task<IEnumerable<Characters>> GetAllCharactersAsync() => await _context.Characters.ToListAsync();
        ...
        // GAME MECHANICS
        public async Task<IEnumerable<GameMechanics>> GetAllGameMechanicsAsync() => await _context.GameMechanics.ToListAsync();
        ...
        // GAME ITEMS
        public async Task<IEnumerable<GameItems>> GetAllGameItemsAsync() => await _context.GameItems.ToListAsync();
        ...
        // LOCATIONS
        public async Task<IEnumerable<Locations>> GetAllLocationsAsync() => await _context.Locations.ToListAsync();
