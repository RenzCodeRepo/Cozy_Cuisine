        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    URLGif = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_About", x => x.DetailsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FAQURLImageList = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    URLGifOrVideo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    URLImageList = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameDownloads", x => x.DownloadId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    URLNewsImageList = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wiki", x => x.WikiId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameReview", x => x.ReviewId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GameMechId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WikiId = table.Column<int>(type: "int", nullable: false),
                    GMName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Category = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    URLImageList = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameMechanics", x => x.GameMechId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoryPlot", x => x.StoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BugReport_PatchId",
                table: "BugReport",
                column: "PatchId");

            migrationBuilder.CreateIndex(
                name: "IX_Characters_WikiId",
                table: "Characters",
                column: "WikiId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameItems_WikiId",
                table: "GameItems",
                column: "WikiId");

            migrationBuilder.CreateIndex(
                name: "IX_GameMechanics_WikiId",
                table: "GameMechanics",
                column: "WikiId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_WikiId",
                table: "Locations",
                column: "WikiId");

            migrationBuilder.CreateIndex(
                name: "IX_StoryPlot_WikiId",
                table: "StoryPlot",
                column: "WikiId");
        }
